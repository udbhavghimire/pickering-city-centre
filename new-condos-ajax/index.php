...
<head>
    ...
    <title> New Condos for sale in Ajax | Register Today</title>

    <meta name="title" content="Pre construction homes for sale in Ajax | Register Today">
    <meta name="description" content="New Construction  Condos in Ajax | Find Pre construction condos in Ajax. Plans & pricing.">
        ...
        <div class="pt-2" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="50">
            <div class="container pt-3 " id="newcondos">
                ...
                <div class="pt-md-5 pt-5">
                    ...
                    Top Pre construction Condos in Ajax | New Updates*
                    </h1>
                    <span class="small-text text-center d-flex justify-content-center custom-underline pb-3 mx-1">New Pre construction Condos for sale in Ajax, Ontario </span>
                </div>
                <div class="rounded-3">
        ...
        <div class="pt-2" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="50">
            <div class="container pt-3 " id="newcondos">
                ...
                <div class="pt-md-5 pt-5">
                    ...
                    Past Pre Construction Condos in Ajax
                    </h2>
                    <span class="small-text text-center d-flex justify-content-center custom-underline pb-3 mx-1">See the pricing, plans & information about previous pre-construction condos sold in Ajax</span>
                </div>
                <div class="rounded-3">
                    <div class="d-flex justify-content-between pb-3">
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 justify-content-center g-4 mt-2">
        ...
        <div class="pt-5 " id="Contact">
            <div class="pt-5 mt-5 " data-aos="fade-up" data-aos-duration="2000" data-aos-delay="50">
                <div class="row mx-0 " >
                    ...
                    <h6 class="text-center fs-1 fw-bold pt-3 register "> Send me latest update on Ajax </h6>
                    <div class="registertext px-4 d-flex justify-content-center align-items-center text-center ">
                        <p>Register today and get the latest update on Ajax Pre Construction Condos
                        </p>
                    </div>
                ...
                <div class="row row-cols-1 row-cols-md-3 mx-0 g-5 pb-md-5 ">
                    ...
                    <div class="col-md-6 px-md-5 ">
                        ...
                        <form action="../contactForm.php" method="POST">
                            ...
                            <div class="row ">
                                <p class=" text-muted sm-text text-center mt-0 ">*I consent to receive future communications about Pre construction homes in Ajax. I understand I can opt out at anytime by sending an email.</p>
                            </div>
                            <div class="row ">
