...
<head>
    ...
    <title>Oshawa New Construction Homes | Daily Updates </title>

    <meta name="title" content="Oshawa New Construction Homes | Daily Updates ">
        ...
        <div class="pt-2" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="50">
            <div class="container pt-3 " id="newcondos">
                ...
                <div class="pt-md-5 pt-5">
                    ...
                    <span class ="bg-color">    Top Pre construction homes in Oshawa | New Updates* </span>
                    </h1>
        ...
        <div class="pt-2" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="50">
            <div class="container pt-3 " id="newcondos">
                ...
                <div class="pt-md-5 pt-5">
                    ...
                    <span class ="bg-color">  Past Pre Construction Projects in Oshawa </span>
                    </h2>
                    <span class="small-text text-center d-flex justify-content-center custom-underline pb-3 mx-1">See the pricing, plans & information about previous pre-construction homes sold in Oshawa</span>
                </div>
                <div class="rounded-3">
                    <div class="d-flex justify-content-between pb-3">
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 justify-content-center g-4 mt-2">
