  ...
  <section class="pt-3 py-md-5">
                        ...
                        <div class="">
                            <div>
                                ...
                                <div class="pt-2 pt-sm-2 pt-md-2 rounded-mine mt-3 ">
                                    ...
                                    Pickering City Centre Condos is a new condo development by CentreCourt Developments currently in planning at 1355 A Kingston Road, Pickering, ON. The development is launching in  2023. Pickering City Centre Condos has a total of 55 Storeys.
                                ...
                                <p class="mybot pb-md-0 pb-0 ">
                                    Address:  1355 A Kingston Rd, Pickering
                                </p>
                                <p class="mybot pb-md-0 pb-0 ">
                                Occupancy: TBD
                                </p>
    ...
    <section>
       ...
       <div class="d-flex justify-content-center p-1">
        <div style="padding: 0; margin: 0; border: 0; outline: 0; width: 300px; border: 1px solid #999;"> <div style="border:0;outline:0;padding:0; margin: 11px 9px 0;"><h2 style="text-overflow: ellipsis; overflow: hidden; white-space: nowrap; padding: 0; margin: 0; border: 0; outline: 0; text-decoration: none; vertical-align: baseline; font-style: normal; background: none; text-align: left; font:15px/19px 'Arial Black', Gadget, sans-serif; font-weight: normal; color: #222;"> 1355 Kingston Road </h2><h3 style="text-overflow: ellipsis; overflow: hidden; white-space: nowrap; padding: 0; margin: 0; border: 0; outline: 0; text-decoration: none; vertical-align: baseline; font-style: normal; background: none; text-align: left; font:12px/14px Verdana, Arial, Helvetica, sans-serif; font-weight: bold; color: #666; margin: 2px 0 4px 0;"> Somewhat Walkable </h3> <div style="padding: 0; margin: 0; border: 0; outline: 0; position: relative; width: 100%; padding-bottom: 30%"> <div style="padding: 0; margin: 0; border: 0; outline: 0; position: absolute; top: 0; bottom: 0; left: 0; right: 0;"> <a rel="nofollow" href="https://www.walkscore.com/score/1355-Kingston-Road-Pickering--CA.dash.ON-L1V-1B8?utm_source=badge&utm_medium=responsive&utm_campaign=badge"><!--[if lte IE 8]><img src="//pp.walk.sc/badge/walk/1355-Kingston-Road-Pickering--CA.dash.ON-L1V-1B8.png" style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'alt="Walk Score of 1355 Kingston Road Pickering ON Canada"><![endif]--> <!--[if gt IE 8]><img src="//pp.walk.sc/badge/walk/1355-Kingston-Road-Pickering--CA.dash.ON-L1V-1B8.svg" style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'alt="Walk Score of 1355 Kingston Road Pickering ON Canada"><![endif]--> <!--[if !IE]> <!-- --><img src="//pp.walk.sc/badge/walk/1355-Kingston-Road-Pickering--CA.dash.ON-L1V-1B8.svg" style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'alt="Walk Score of 1355 Kingston Road Pickering ON Canada"><!-- <![endif]--><!--[if lte IE 8]><img src="//pp.walk.sc/badge/transit/1355-Kingston-Road-Pickering--CA.dash.ON-L1V-1B8.png" style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'alt="Transit Score of 1355 Kingston Road Pickering ON Canada"><![endif]--> <!--[if gt IE 8]><img src="//pp.walk.sc/badge/transit/1355-Kingston-Road-Pickering--CA.dash.ON-L1V-1B8.svg" style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'alt="Transit Score of 1355 Kingston Road Pickering ON Canada"><![endif]--> <!--[if !IE]> <!-- --><img src="//pp.walk.sc/badge/transit/1355-Kingston-Road-Pickering--CA.dash.ON-L1V-1B8.svg" style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'alt="Transit Score of 1355 Kingston Road Pickering ON Canada"><!-- <![endif]--><!--[if lte IE 8]><img src="//pp.walk.sc/badge/bike/1355-Kingston-Road-Pickering--CA.dash.ON-L1V-1B8.png" style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'alt="Bike Score of 1355 Kingston Road Pickering ON Canada"><![endif]--> <!--[if gt IE 8]><img src="//pp.walk.sc/badge/bike/1355-Kingston-Road-Pickering--CA.dash.ON-L1V-1B8.svg" style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'alt="Bike Score of 1355 Kingston Road Pickering ON Canada"><![endif]--> <!--[if !IE]> <!-- --><img src="//pp.walk.sc/badge/bike/1355-Kingston-Road-Pickering--CA.dash.ON-L1V-1B8.svg" style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'alt="Bike Score of 1355 Kingston Road Pickering ON Canada"><!-- <![endif]--></a></div> </div><p style="text-overflow: ellipsis; overflow: hidden; white-space: nowrap; padding: 0; margin: 0; border: 0; outline: 0; color: #999; font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif; line-height: 13px; clear:both; padding: 8px 0;"><a rel="nofollow" style="text-overflow: ellipsis; overflow: hidden; white-space: nowrap; padding: 0; margin: 0; border: 0; outline: 0; text-decoration: none; vertical-align: baseline; font-style: normal; background: none; text-align: left; color: #999; font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif; line-height: 13px;" target="_blank" href="https://www.walkscore.com/CA-ON/Pickering?utm_source=badge&utm_medium=responsive&utm_campaign=badge">Explore Pickering on Walk Score</a><img style="visibility: hidden;" width=1 height=1 src="https://www.redfin.com/rift?ev=external_web&p=walkscore&s=score_badge&a=impression" /> </p></div></div>
       </div>
        <div class="pt-4 ">
        <span class="small-text text-center d-flex justify-content-center custom-underline pb-3 textt">(Pickering City Centre Condos) 
        1355 Kingston Road has a Walk Score of 62 out of 100. This location is Somewhat Walkable so some errands can be accomplished on foot.

1355 Kingston Road is a six minute walk from the LE Lakeshore East at the Pickering GO stop.

This location is in Pickering. Nearby parks include David Farr Memorial Park South, Glengrove Park and Douglas Park.
    ...
    <section data-aos="fade-up" >
        <div class="container pt-md-5 pt-5" id="location">
            ...
            <div class="py-5" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="50">
                ...
                <span class="small-text text-center d-flex justify-content-center custom-underline pb-3 px-2">Walk around the neighbourhood near Pickering City Centre Condos</span>
                <div class="p-1  d-flex justify-content-center">
                <iframe src="https://www.google.com/maps/embed?pb=!4v1689926515479!6m8!1m7!1stqzy3q99aaTpFWh16WUm7Q!2m2!1d43.83375334162195!2d-79.08787259654953!3f303.4267123812106!4f5.050635881790612!5f0.4000000000000002" width="900" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
        ...
        <div class="container ">
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-5 pt-5 justify-content-between ">
                <div class="col-md-5 my-3 fotwidth center-sm px-4 px-md-0 ">
                    <p class=" ">
                        <h2 class="navbar-brand-foot fs-4"><a href="https://homebaba.ca/pickering/pickering-city-centre-condos" target="_blank" class = "text-dark text-decoration-none">Pickering City Centre </a></h2>
                    </p>
                    <span class=" justifyy ">
                    We do not represent the builder. Information provided on this website is gathered from publicly available websites. The information might not be updated and could include inaccurate or outdated information such as location, pricing, availability, floor plans etc. To learn more about Pickering City Centre Condos, please contact the builder directly. </span>
                ...
                <div class="col-md-4 py-md-5 py-5 center-sm px-md-5 px-5 ">
                    <div>
                        <h5 class="text-dark fw-bold mt-3 mb-3 ">About Pickering City Centre</h5>
                ...
                <div class="col-md-3 mt-sm-0 pt-4 center-sm d-flex justify-content-around align-items-center text-center ">
                    <img src="images/centre-court-logo.svg" class="img-fluid footer-logo " alt="centre-court-logo">
